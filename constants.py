...
DELAY_AFTER_COIN_TOSS = 3
DELAY_AFTER_TURN_NOTICE = 1
DELAY_BEFORE_ACTION = 0
DELAY_BEFORE_CARD_OPEN = 5
DELAY_BEFORE_COIN_TOSS = 3
DELAY_BEFORE_GAME_START = 5
DELAY_AFTER_DUEL_ENDS = 5
DELAY_AFTER_GAME_ENDS = 5
DELAY_AFTER_DECK_CHOICE = 3
DELAY_AFTER_INVALID_DECK_CHOICE = 0
DELAY_BEFORE_DECK_CHOICE = 1
